...
Page({
  data: { themeMode: getThemeMode(), members: [], filteredMembers: [], search: '', activeTag: '全部', tags: ['全部', 'AI 产品', '设计', '独立开发', '找搭子', '线下活动'] },
  onLoad() { this.setData({ themeMode: getThemeMode() }); this.refresh(); }, onShow() { this.setData({ themeMode: getThemeMode() }); this.refresh(); }, onPullDownRefresh() { this.refresh(); wx.stopPullDownRefresh(); },
